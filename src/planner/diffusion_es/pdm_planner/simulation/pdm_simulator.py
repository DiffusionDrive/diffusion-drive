...
from src.planner.diffusion_es.pdm_planner.simulation.batch_kinematic_bicycle import (
    BatchKinematicBicycleModel,
)
from src.planner.diffusion_es.pdm_planner.simulation.batch_lqr import (
    BatchLQRTracker,
)
...
class PDMSimulator:
    ...
    def simulate_proposals(
        ...
        self._commands = np.zeros(
            (proposal_states.shape[0], proposal_states.shape[1] - 1, 2),
            dtype=np.float64,
        )
