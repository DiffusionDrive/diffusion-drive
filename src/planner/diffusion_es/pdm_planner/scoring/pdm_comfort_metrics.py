...
def _compute_lon_acceleration(
    ...
    return _within_bound(
        lon_acceleration,
        min_bound=comfort_config["min_lon_accel"],
        max_bound=comfort_config["max_lon_accel"],
    )
...
def _compute_lat_acceleration(
    ...
    return _within_bound(
        lat_acceleration,
        min_bound=-comfort_config["max_abs_lat_accel"],
        max_bound=comfort_config["max_abs_lat_accel"],
    )
...
def _compute_jerk_metric(
    ...
    return _within_bound(
        jerk_metric,
        min_bound=-comfort_config["max_abs_mag_jerk"],
        max_bound=comfort_config["max_abs_mag_jerk"],
    )
...
def _compute_lon_jerk_metric(
    ...
    return _within_bound(
        lon_jerk_metric,
        min_bound=-comfort_config["max_abs_lon_jerk"],
        max_bound=comfort_config["max_abs_lon_jerk"],
    )
...
def _compute_yaw_accel(
    ...
    return _within_bound(
        yaw_accel_metric,
        min_bound=-comfort_config["max_abs_yaw_accel"],
        max_bound=comfort_config["max_abs_yaw_accel"],
    )
...
def _compute_yaw_rate(
    ...
    return _within_bound(
        yaw_rate_metric,
        min_bound=-comfort_config["max_abs_yaw_rate"],
        max_bound=comfort_config["max_abs_yaw_rate"],
    )
