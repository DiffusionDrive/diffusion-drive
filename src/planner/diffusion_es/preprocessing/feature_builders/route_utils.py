...
from src.planner.diffusion_es.pdm_planner.utils.graph_search.bfs_roadblock import (
...
def get_closed_loop_route(
    ...
    # path planning
    roadblocks, roadblock_ids = (
        list(roadblock_dict.values()),
        list(roadblock_dict.keys()),
    )
